                                ...
                                @foreach ($items as $item)
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute {{ $item->category->cat_name == 'Makanan' ? 'bg-warning' : ($item->category->cat_name == 'Minuman' ? 'bg-info' : 'bg-primary') }}"
